...
`MergedManifestContractTest.theMergedManifestPermissionSetIsExactly` (a second class in `app/src/test/kotlin/com/loosecannon/servicetag/reminders/ManifestContractTest.kt`, beside `ManifestContractTest`, which carries the exported-set assertion) is **unchanged** — `ACTION_SEND`
...
`MergedManifestContractTest.theMergedManifestPermissionSetIsExactly` (a second class in `app/src/test/kotlin/com/loosecannon/servicetag/reminders/ManifestContractTest.kt`, beside `ManifestContractTest`, which carries the exported-set assertion) is unchanged; a backup exported on
