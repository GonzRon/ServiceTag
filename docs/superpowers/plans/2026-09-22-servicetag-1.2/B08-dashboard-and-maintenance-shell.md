...
**Ratified, verbatim** (master plan §17): **"Maintenance"** (the navigation label), the section labels **ATTENTION · UPCOMING · CURRENT · OUT OF SEASON**, the status terms **OK · DUE SOON · DUE · OVERDUE · OUT OF SEASON · PAUSED · NO BASELINE**, the progress form **"3 of 5 complete"**, **"Reminders are off because notifications are blocked."** (the one-line dismissible dashboard line, shown when notifications are denied — D-22), and **"Log meter reading"** where a `NO_DATA` row offers its repair.

**PROPOSED, drafted by this brief and returned for ratification before it executes** (master plan §18 decision 12): the Maintenance destination's **four section labels** (the headings over due work, schedules, maintenance groups and reminder health) and its **empty-state line** for a phone with no schedules yet. Draft them short, in the register of the existing screens, and hand them to the controller with the brief's plan review. **Do not ship an unratified heading.**
