...
- The format-7 providerless emulator export from step 5 is kept under `noteNFC-backups/` as the reproducer for future migration proofs unless told not to.
